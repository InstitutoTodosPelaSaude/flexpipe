...
def _colormap_sample(cmap_name: str, n_members: int) -> list:
    ...
    return [
        ...
        for i in range(2, cmap.N - 2)  # skip the extreme ends
    ]
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Generate a colour scheme TSV (field/value/hex_color) from metadata "
            "and a hue table."
        ),
    ...
    parser.add_argument("--levels",  required=True, nargs="+", type=str,
